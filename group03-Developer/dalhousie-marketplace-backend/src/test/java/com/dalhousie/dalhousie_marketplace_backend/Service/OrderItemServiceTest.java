...
public class OrderItemServiceTest {
    ...
    private final Long USER_ID_2 = 999L;
    private final Long ORDER_ID = 301L;
    private final int NO_OF_DAYS = 7;
    private final int EXPECTED_VALUE = 2;
    ...
    void setUp() {
        ...
        completedOrder.setOrderDate(LocalDateTime.now().minusDays(NO_OF_DAYS)); // 1 week old order
    ...
    void testIsEligibleToReview_DifferentUser() {
        // Arrange
        completedOrder.setUserId(USER_ID_2); // Different user
        when(orderItemRepository.findById(ORDER_ITEM_ID)).thenReturn(Optional.of(completedOrderItem));
